...
| --------------------------------------------------------------------------------------------  | 
| Poder subir un tópico|
|Poder mostrar tópicos relacionados al título de búsqueda|
|Poder descargar|
|Poder ver videos o imágenes|
...
|--------------------------------------------------------------------------------------------  | 
| *Alto impacto:*|
|Que el usuario no sepa como subir un típico.|
|Que el software sea difícil de comprender.|
|El topico dure mucho al cargar.|
|No saber utilizar una computadora.|
|Que no se conecte de forma adecuada la base de datos.| 
|*Mediano impacto:* |
El diseño no sea lo esperado|
|Los colores para el diseño no sean los adecuados.|
|Atrasos por días festivos.|
...
|•	Diseño de la aplicación……………………………………..….$20,000|
|•	Desarrollo del software………………………………….…….$50,000|
•	Pruebas y corrección…………………………………………...$15,000|
...
|**Supuestos**   | 
| --------------------------------------------------------------------------------------------  | 
|Se dara una capacitación para el uso de la plataforma.|
|Todos tienen una computadora o celular.|
|La empresa cuneta con internet.|
|La plataforma tendra el rol de usuario y de administrador.|
...
|**Restricciones**   |
|-------------------------------------------------------------------------------------------- |
|Se necesita de una computadora o un celular para entrar a la plataforma.|
|Se necesita un usuario para poder ver algun topico.|
|Se debe de validar el típico antes de subirlo.|
|Debe de ser un empleado para poder descargar o ver un topico.|
