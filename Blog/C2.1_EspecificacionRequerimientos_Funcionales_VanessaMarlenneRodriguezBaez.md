...
|📁 **Requisito RFN-03: Búsqueda**  |
|:----|
| **Detalle:** <br> El sistema permitirá realizar más de una búsqueda a la vez.
|**Precondición:** <br> :one: Deberá cumplirse el requerimiento RFN-13.<br> :two: Dene de existir Tópicos en la base de datos. <br> :three: |
...
|📁 **Requisito RFN-05: Acceso controlado**  |
|:----|
| **Detalle:** <br> El sistema permitirá aprobar las actualizaciones.
|**Precondición:** <br> :one: <br> :two: <br> :three: |
|**Secuencia normal** <br> :one: <br> :two:  <br> :three:  <br> :four:  <br>
|**Post-condición** <br> :one: 
|**Excepciones** <br> :one: |

|📁 **Requisito RFN-06: Modificación**  |
|:----|
...
|📁 **Requisito RFN-09: Eliminacion de usuarios**  |
|:----|
...
|📁 **Requisito RFN-10: Descargas**  |
|:----|
| **Detalle:** <br> El sistema permitirá al usuario descargar un tópico.
...
|📁 **Requisito RFN-11: Guardar**  |
|:----|
| **Detalle:** <br> El usuario podrá guardar los tópicos que desee.
...
|📁 **Requisito RFN-12: Administrador**  |
|:----|
...
|📁 **Requisito RFN-13: Iniciar sesión**  |
|:----|
...
|📁 **Requisito RFN-15: Tópicos relacionados**  |
|:----|
