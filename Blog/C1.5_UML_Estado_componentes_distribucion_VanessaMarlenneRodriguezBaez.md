...
2. Elabore los siguientes diagramas:
  ...
  ![DEstados](../Diagramas/DiagramaEstado.drawio.png)

   ## Diagrama de **de componentes**
  ![DComponentes](../Diagramas/DiagramaComponentes.drawio.png)

  ## Diagrama de **de distribución**
  ![DDistribucion](../Diagramas/DiagramaDistribuucion.drawio.png)
